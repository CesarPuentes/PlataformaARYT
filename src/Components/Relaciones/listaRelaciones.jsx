...
function ListaRelaciones(props) {
  ...
  /* Imprimir */
  let handleImprimir = evt => {
    setId(evt[0]);
    console.log("Generando documento para ID " + evt);
    axios.get(`http://localhost:4000/doc/${evt}`)
  }
                  ...
                  <TableRow key={relacion.id}>
                        ...
                        <DialogContent dividers>
                          <div className="tabla">
                            ...
                            <TextField
                              ...
                              onChange={e =>
                                setCodigo_consecutivo(e.target.value)
                              }
                            ...
                            <TextField
                              ...
                              onChange={e =>
                                setNombres_candidato(e.target.value)
                              }
                    ...
                    <TableCell align="center">
                      ...
                      <Button
                        ...
                        onClick={e => handleDelete(relacion.id)}
                      >
                        <div>Borrar</div>
                      </Button>
                    </TableCell>
                    <TableCell align="center">
                      ...
                      <Button
                        data-testid="boton-borrar"
                        onClick={e => handleImprimir(relacion.id)}
                      >
                        <div>Informe</div>
                      </Button>
                    </TableCell>
  ...
  return (
    <div data-testid="listaRelacionesMainTest">
      <MainNavbar />
      <br />
      <h1>Lista</h1>
      {displayRelaciones()}
