...
var EditarListaRelaciones = /** @class */ (function (_super) {
    __extends(EditarListaRelaciones, _super);
    function EditarListaRelaciones(props) {
    ...
    EditarListaRelaciones.prototype.submitForm = function (e) {
        e.preventDefault();
    ...
    EditarListaRelaciones.prototype.render = function () {
        var _this = this;
    ...
    return EditarListaRelaciones;
}(react_1.default.Component));
exports.default = react_apollo_1.compose(react_apollo_1.graphql(queries_1.GetRelacionesQuery, { name: "GetRelacionesQuery" }), react_apollo_1.graphql(queries_1.addRelacionMutation, { name: "addRelacionMutation" }))(EditarListaRelaciones);
